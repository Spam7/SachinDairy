...
export class WingWiseReportComponent implements OnInit, AfterViewChecked {
  ...
  ngOnInit() {
    ...
    // this.spinner = this.aR.queryParams.subscribe((res)=>{
    //   this.selectedDate=((new Date(res.year,res.month-1,res.day)).getTime())/1000;
    //   console.log(this.selectedDate);
    //   this.selectedDateSubscriptions();
    //   this.getDeliveryStatus(this.selectedDate);
    // })
    // this.spinner.subscribe(()=>this.showSpinner=false);
